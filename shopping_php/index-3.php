...
<head>
    ...
    <body>
        ...
        <header>
            ...
            <div class="extra-info">
                ...
                <div class="side-info-bottom">
                    <div class="side-cta">
                        <p><a href="https://wphix.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="6a03040c052a0f120b071a060f44090507">[email&#160;protected]</a></p>
        ...
        <main>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-xl-5 col-lg-5 col-md-4">
                                    <div class="slide-img" data-animation="fadeInLeft" data-delay=".2s">
                    ...
                    <div class="single-slider d-flex align-items-center">
                        <div class="container">
                            <div class="row">
                                <div class="col-xl-5 col-lg-5 col-md-4">
                                    <div class="slide-img" data-animation="fadeInLeft" data-delay=".2s">
                                        <img src="img/slider/slide3-2.jpg" alt="">
                                    </div>
                                </div>
                                <div class="col-xl-7 col-lg-7 col-md-8">
                                    <div class="shape-title shape-title-3 bounce-animate">
                                    ...
                                    <div class="shape-icon shape-icon-3 bounce-animate">
                                        <img src="img/slider/slide-thumb-2.png" alt="">
                                    </div>
                                    <div class="slide-content slide-content-3 pt-80 pl-30">
                                        <span data-animation="fadeInRight" data-delay=".4s">winter Collection</span>
                                        <h1 data-animation="fadeInUp" data-delay=".6s">Winter
                    ...
                    <div class="single-slider d-flex align-items-center">
                        <div class="container">
                            <div class="row">
                                <div class="col-xl-5 col-lg-5 col-md-4">
                                    <div class="slide-img" data-animation="fadeInLeft" data-delay=".2s">
                                        <img src="img/slider/slide3-3.jpg" alt="">
                                    </div>
                                </div>
                                <div class="col-xl-7 col-lg-7 col-md-8">
                                    <div class="shape-title shape-title-3 bounce-animate">
                                    ...
                                    <div class="shape-icon shape-icon-3 bounce-animate">
                                        <img src="img/slider/slide-thumb-3.png" alt="">
                                    </div>
                                    <div class="slide-content slide-content-3 pt-80 pl-30">
                                        <span data-animation="fadeInRight" data-delay=".4s">winter Collection</span>
                                        <h1 data-animation="fadeInUp" data-delay=".6s">Winter
                    ...
                    <div class="product-slider-2 owl-carousel">
                        <div class="pro-item">
                            <div class="product-wrapper mb-50">
                                <div class="product-img mb-25">
                                    <a href="product-details.html">
                                        <img src="img/product/pro21.jpg" alt="">
                                        <img class="secondary-img" src="img/product/pro22.jpg" alt="">
                                    </a>
                            ...
                            <div class="product-wrapper mb-50">
                                <div class="product-img mb-25">
                                    <a href="product-details.html">
                                        <img src="img/product/pro22.jpg" alt="">
                        ...
                        <div class="pro-item">
                            <div class="product-wrapper mb-50">
                                <div class="product-img mb-25">
                                    <a href="product-details.html">
                                        <img src="img/product/pro23.jpg" alt="">
                                        <img class="secondary-img" src="img/product/pro24.jpg" alt="">
                                    </a>
                                    <div class="product-action text-center">
                                        <a href="#" title="Shoppingb Cart">
                                            <i class="flaticon-shopping-cart"></i>
                            ...
                            <div class="product-wrapper mb-50">
                                <div class="product-img mb-25">
                                    <a href="product-details.html">
                                        <img src="img/product/pro24.jpg" alt="">
                                        <img class="secondary-img" src="img/product/pro25.jpg" alt="">
                                    </a>
                                    <div class="product-action text-center">
                                        <a href="#" title="Shoppingb Cart">
                                            <i class="flaticon-shopping-cart"></i>
                        ...
                        <div class="pro-item">
                            <div class="product-wrapper mb-50">
                                <div class="product-img mb-25">
                                    <a href="product-details.html">
                                        <img src="img/product/pro25.jpg" alt="">
                                        <img class="secondary-img" src="img/product/pro26.jpg" alt="">
                                    </a>
                                    <div class="product-action text-center">
                                        <a href="#" title="Shoppingb Cart">
                                            <i class="flaticon-shopping-cart"></i>
            ...
            <section class="upcoming-product-area pos-relative box-90 pt-120 pb-120" data-background="img/bg/bg2.jpg">
